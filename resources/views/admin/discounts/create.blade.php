...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h4 mb-0 text-gray-800">ایجاد تخفیف</h1>
    </div>
    {{-- /page heading --}}
    <hr class="">
    ...
    <form action="{{ route('admin.discounts.store') }}" method="POST">
        ...
        <div class="row mb-3">
            <div class="col-md-6 mb-3 mb-md-0">
                ...
                <select name="courses[]" id="courses" class="form-control" multiple>
                    @foreach ($courses as $course)
                        <option value="{{ $course->id }}">{{ $course->name_fa }}</option>
                    @endforeach
                </select>
            </div>
            ...
            <div class="col-md-6 mb-3 mb-md-0">
                ...
                <input class="form-control" type="text" id="users" name="users" value="{{ old('users') }}"
        ...
        <div class="row mb-3">
            <div class="col-md-6 mb-3 mb-md-0">
                ...
                <select name="type" id="type" class="form-control">
                    ...
                    <option value="value">مبلغی</option>
                </select>
            </div>
            <div class="col-md-6 mb-3 mb-md-0">
        ...
        <div class="row mb-3">
            <div class="col-md-6 mb-3 mb-md-0">
                ...
                <div class="input-group">
                    ...
                    <input type="text" name="expire_at" value="{{ old('expire_at') }}" class="form-control">
                </div>
                <div class="mt-3 mr-3">

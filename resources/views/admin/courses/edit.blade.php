...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h4 mb-0 text-gray-800">ویرایش دوره</h1>
    </div>
    {{-- /page heading --}}
    <hr class="">
    ...
    <form action="{{ route('admin.courses.update', $course->slug) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row mb-3">
            <div class="col-md-6 mb-3 mb-md-0">
                ...
                <input class="form-control" type="text" id="name_fa" name="name_fa"
                    value="{{ old('name', $course->name_fa) }}">
            </div>
            <div class="col-md-6 mb-3 mb-md-0">
                <label for="name">نام لاتین</label>
                <input class="form-control" type="text" id="name_en" name="name_en"
                    value="{{ old('name', $course->name_en) }}">
            </div>
            <div class="col-md-6 mb-3 mb-md-0">
                <label for="teacher">مدرس</label>
                <input class="form-control" type="text" id="teacher" name="teacher"
        ...
        <div class="row mb-3">
            <div class="col-12">
                ...
                <textarea class="form-control" id="description" name="description" rows="3" placeholder="(برای استفاده در موتور های جستجو).لطفا متن این قسمت را با دقت وارد کرده و نسبت به دیگر دوره ها متمایز کنید همچنین از همین متن درون محتوای دوره استفاده کنید">{{ old('description',$course->description) }}</textarea>
            </div>
        </div>
        <div class="row mb-3">
            <div class="col-md-6 mb-3 mb-md-0">
        ...
        <div class="row mb-3">
            <div class="col-md-6 mb-3 mb-md-0">
                ...
                <input class="form-control" type="text" id="discount_off" name="discount_off"
                    value="{{ old('discount_off', $course->discount_off) }}">
            ...
            <div class="col-md-6 mb-3 mb-md-0">
                ...
                <div class="input-group">
                    ...
                    <input type="text" name="discount_expire_at"
                        value="{{ old('discount_expire_at', $course->discount_expire_at ? jdate($course->discount_expire_at) : '') }}"
                        class="form-control">
                </div>
        ...
        <div class="row mb-3" id="file-manager">
            ...
            <div class="col-md-6 text-center" id="course_image">
                @include('admin.courses.image', ['url' => $course->image])
            </div>
        </div>

        <hr>
        <div class="accordion" id="sectionsAccrodian">
            <button type="button" class="btn d-flex justify-content-between col-12" data-toggle="collapse"
                data-target="#sections">
                <span>بخش ها</span>
                <i class="fa fa-arrow-left"></i>
            </button>
            <div class="collapse p-4" id="sections">
                @foreach ($course->sections as $key => $section)
                    <div class="row align-items-center" id="section-{{ $key }}">
                        ...
                        <div class="form-group">
                            <label>نام</label>
                            <input class="form-control" type="text" name="section[{{ $section->id }}]"
                                value="{{ $section->name }}">
                        </div>
                    </div>
                @endforeach
        ...
        <div class="row mb-3">
            <div class="col-12">
                ...
                <textarea class="form-control" rows="10" id="content" name="content">{{ old('content', $course->content) }}</textarea>
            </div>
            <div class="mt-3 mr-3">
        ...
        <div class="text-left mt-5">
            ...
            <button type="submit" class="btn btn-success">ویرایش دوره</button>
        </div>

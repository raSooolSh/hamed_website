...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h4 mb-0 text-gray-800">ویرایش مطلب</h1>
    </div>
    {{-- /page heading --}}
    <hr class="">
    ...
    <form action="{{ route('admin.articles.update',$article->slug) }}" method="POST">
        ...
        <div class="row mb-3">
            <div class="col-md-6 mb-3 mb-md-0">
                ...
                <input class="form-control" type="text" id="title" name="title" value="{{ old('title',$article->title) }}">
            </div>
            <div class="col-md-6 mb-3 mb-md-0">
                <label for="type">نوع</label>
                <select class="form-control" id="type" name="type">
                    <option value="news" selected>خبری</option>
                    <option value="article"{{ $article->getRawOriginal('type') == 'article' ? "selected" : '' }}>مقاله</option>
                </select>
            </div>
        </div>
        <div class="row mb-3">
        ...
        <div class="row mb-3">
            <div class="col-md-6 mb-3 mb-md-0">
                ...
                <select class="form-control" id="is_active" name="is_active">
                    ...
                    <option value="0" {{ $article->is_active ? '':'selected' }}>غیرفعال</option>
                </select>
            </div>
        </div>
        ...
        <div class="row mb-3">
            <div class="col-12">
                ...
                <textarea class="form-control" rows="10" id="content" name="content">{{ old('content',$article->content) }}</textarea>
            </div>
            <div class="mt-3 mr-3">

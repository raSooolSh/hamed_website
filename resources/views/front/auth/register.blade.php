                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3 justify-content-center">
                            <div class="col-md-10 ">
                                <input id="first_name" type="text"
                                    ...
                                    value="{{ old('first_name') }}" placeholder="نام خود را به فارسی وارد کنید"
                        ...
                        <div class="row mb-3 justify-content-center">
                            <div class="col-md-10 ">
                                <input id="last_name" type="text"
                                    ...
                                    value="{{ old('last_name') }}" placeholder="نام خانوادگی را به فارسی وارد کنید"
                        ...
                        <div class="row mb-3 justify-content-center" id="phone_div">
                            <div class="col-md-8">
                                <input id="phone_number" type="text"
                                    ...
                                    value="{{ old('phone_number') }}" placeholder="شماره تماس همراه برای مثال 09121234567"
                                    autofocus>
                                @error('phone_number')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                            ...
                            <div class="col-md-2 text-end mt-1">
                                <button id="sendVerifyCode_btn" type="button"
                                    class="btn btn-secondary col-12 disabled">ارسال
                                    پیامک</button>
                            </div>
                        ...
                        <div class="row mb-3 justify-content-center">
                            <div class="col-md-10">
                                ...
                                <label for="terms" class="form-check-label text-white"><a href=""
                                        class="@error('terms') text-danger @enderror text-primary">قوانین و مقررات </a>را
                                    خوانده ام و آنرا می پذیرم</label>
                            </div>
                        </div>

                        <div class="row justify-content-center py-3">
                            <div class="col-md-10">
                                <button type="submit" class="btn btn-primary col-12 disabled" id="registerBtn">ثبت نام <i

                        ...
                        <div>
                            ...
                            <form method="POST" action="{{ route('resetPassword') }}">
                                ...
                                <div class="row mb-3 justify-content-center">
                                    <div class="col-md-10">
                                        <input id="password" type="password"
                                            ...
                                            placeholder="گذر واژه جدید شامل اعداد و حروف لاتین" autocomplete="new-password">
                                ...
                                <div class="row mb-3 justify-content-center">
                                    <div class="col-md-10">
                                        <input id="password_confirmation " type="password" class="form-control"
                                            name="password_confirmation" placeholder="گذر واژه جدید خود را مجددا وارد کنید">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3 justify-content-center">
                                    <div class="col-md-8">
                                        <input id="verify_code" type="text"
                                            ...
                                            name="verify_code" value="{{ old('verify_code') }}"
                                            placeholder="کد تایید درون پیامک را وارد کنید">
                                    ...
                                    <div class="col-md-2 text-end mt-1">
                                        <button id="sendVerifyCode_btn" type="button"
                                            class="btn btn-secondary col-12">ارسال
                                            پیامک</button>
                                    </div>
                                </div>
                                ...
                                <div class="row justify-content-center py-3">
                                    <div class="col-md-10">
                                        <button type="submit" class="btn btn-primary col-12" id="registerBtn"> بازنشانی گذر
                                            واژه <i class="bi bi-person-plus"></i></button>
                                    </div>
                                </div>

                                <div class="row justify-content-center">
                                    <div class="d-flex col-md-10 justify-content-end">
                                        <a href="{{ route('login') }}">بازشگت به صفحه ورود</a>
                                    </div>
                                </div>
                            </form>
